...
{
	public static final String TABLE_ALIAS = "消息提醒";
	...
	public Message( String id , String receiver ,String receiverId, String sponsor , String title ,Date time , String state , Date chackTime , String content ,String status, Date ts )
	{
			this.id=id;
