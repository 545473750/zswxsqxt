...
*/
@Repository
public class MessageDao   extends BaseHibernateDao<Message,String>
{
	...
	*/
	public Page findPage(MessageQuery query,int pageSize,int pageNum)
	{
		String hql=" from Message ett where 1=1";
