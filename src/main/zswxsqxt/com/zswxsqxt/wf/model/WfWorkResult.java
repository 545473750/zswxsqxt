...
{
	public static final String TABLE_ALIAS = "流程工作结果";
	...
	public WfWorkResult(String id)
	{
		this.id=id;
	}
	public WfWorkResult( String id , Integer proResult , String addUserId , String addUserName , String remark , Date ts , WfWork wfWork )
	{
			this.id=id;
