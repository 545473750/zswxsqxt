...
*/
public class WfInstanceFunction
{
	public static final String TABLE_ALIAS = "流程节点功能点表";
	...
	public WfInstanceFunction()
	{
	}
	public WfInstanceFunction(String id)
	{
		this.id=id;
	}
	public WfInstanceFunction( String id , String name , String url , String parName , String description , Integer funType , Integer insType , Integer groupFlag , Date ts )
	{
			this.id=id;
			this.name=name;
			this.url=url;
