...
*/
public class WfWorkProcess
{
	public static final String TABLE_ALIAS = "流程工作任务表";
	...
	public WfWorkProcess()
	{
	}
	public WfWorkProcess(String id)
	{
		this.id=id;
	}
	public WfWorkProcess( String id , String projectId , String actId , Integer proState , Date startTime , Date endTime , String userId , String userName , Date ts , WfWork wfWork )
	{
			this.id=id;
